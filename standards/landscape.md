...
6. **2026-04 重大监管转向**：武汉萝卜快跑事件后 14 天内，国家三部门召开全国安全监管会议，超 10 城同步收紧准入。监管逻辑从"包容审慎"转向"安全底线刚性化、全链条责任闭环化"，要求从单车安全扩展至"云-网-边-车"系统性安全全链条监管，这一转向为 ROAM 框架的标准化提案提供了强有力的产业需求论据
...
YD/T 4778—4783 系列共 6 项标准，由工信部 2024-07-05 批准发布、2024-10-01 实施，归口 CCSA。该系列采用"1+4+1"架构：1 个总体标准 + 4 个场景标准 + 1 个共性技术标准。

| 标准号 | 名称 | 定位 | 覆盖场景/内容 | 主要起草单位 | 与 ROAM 运营模式映射 |
|-------|------|------|------------|-----------|-----------------|
| **YD/T 4778-2024** | 基于 5G 的远程遥控驾驶信息交互系统 总体技术要求 | 总体架构 | 系统架构、通用功能、接口协议 | 中兴、中国移动、华为、百度等 ~40 家 | 全模式通用 |
| **YD/T 4779-2024** | 城市运营车紧急接管技术要求 | 场景标准 | 城市公交/环卫等紧急接管场景 | 重庆大学、中国移动、一汽等 ~20 家 | M7 L4 公交 / M8 微循环 |
| **YD/T 4780-2024** | 自动驾驶出租车云端控制技术要求 | 场景标准 | Robotaxi 云控平台功能与资源 | 百度（牵头）、中国信通院等 16 家 | M1 Robotaxi / M2 OEM 直营 |
| **YD/T 4781-2024** | 高速公路车队远程遥控技术要求 | 场景标准 | 高速编队行驶（Platooning） | 腾讯（牵头）、戴姆勒、高通等 13 家 | （落地价值有限，ROAM 未单独建模） |
| **YD/T 4782-2024** | 物流车遥控驾驶技术要求 | 场景标准 | 物流园区封闭/半封闭场景 | 重庆大学、阿里巴巴等 24 家 | M9 无人配送 / M10 专用环境 |
| **YD/T 4783-2024** | 音视频传输技术要求 | 共性技术 | 音视频编码、传输协议、时延质量 | 横向支撑所有场景 | 支柱 3 通信 |

**系列定位**：YD/T 4778—4783 是目前国内最完整的远程遥控驾驶系列标准，由信通院主导、工信部通信口归口。该系列可视为 3GPP TS 22.186 中"Remote Driving"场景在中国落地的行业实施标准——3GPP 提供需求框架与性能指标上限，YD/T 系列针对中国具体场景细化系统架构、接口协议和业务流程。

**与 ROAM 的互补关系**：YD/T 系列回答"5G 网络如何支撑远程遥控驾驶的信息交互"（通信管道），ROAM 回答"当远程运营出现异常时，谁来做什么、怎么分级处置、如何衡量效果"（运营治理）。两者属于不同层面的互补，ROAM 不重复 YD/T 的通信技术要求，而是在其之上提供运营层的治理框架。

**标准接口空白**：调研确认，GB 强标（车辆安全）与 YD/T 系列（通信技术）之间，在"远程介入能力如何作为安全后备"这一问题上尚未形成明确的标准接口。ROAM 恰好处于这一接缝位置。

**覆盖差异**：YD/T 的 4 个场景标准覆盖了 Robotaxi、公交/环卫、高速编队、物流园区，但 ROAM 的 M3—M6（个人所有类：OEM 订阅、闲时共享、纯私人 L4）完全不在 YD/T 覆盖范围内，这正是 ROAM 的增量价值所在。
